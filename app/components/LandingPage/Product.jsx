      ...
      <div className="relative z-10">
        ...
        <div className="relative min-h-[50vh] flex items-center justify-center px-4 sm:px-6 pt-12 pb-8">
          ...
          >
            ...
            <div className="inline-flex items-center gap-2 px-4 py-2 mb-6 bg-[#00A86B]/10 border border-[#00A86B]/20 rounded-full animate-bounce-gentle">
              ...
              <span className="text-xs sm:text-sm font-medium text-[#00A86B]">AI-Powered Shopping Assistant</span>
            </div>
        ...
        <div className="py-12 px-4 sm:px-6">
          <div className="max-w-6xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-6">
            {[
              { number: "5K+", label: "People in the waitlist", color: "text-[#FD8100]" },
              { number: "35%", label: "Average Savings", color: "text-[#00A86B]" },
              { number: "1M+", label: "Recipes Created", color: "text-[#FD8100]" },
              { number: "EOY 2025", label: "Launching in", color: "text-[#00A86B]" },
            ].map((stat, index) => (
              <div 
                key={index} 
              ...
              >
                <div className={`text-2xl sm:text-3xl font-bold ${stat.color}`}>{stat.number}</div>
                    ...
                    <div className="space-y-4">
                      <div className="flex items-start gap-3 group/item">
                        <div className="mt-1 w-6 h-6 rounded-full bg-[#FD8100]/10 flex items-center justify-center flex-shrink-0 group-hover/item:bg-[#FD8100] transition-colors duration-300">
                          <span className="text-[#FD8100] group-hover/item:text-white text-sm">✓</span>
                        </div>
                    ...
                    <div className="space-y-4">
                      <div className="flex items-start gap-3 group/item">
                        <div className="mt-1 w-6 h-6 rounded-full bg-[#00A86B]/10 flex items-center justify-center flex-shrink-0 group-hover/item:bg-[#00A86B] transition-colors duration-300">
                          <span className="text-[#00A86B] group-hover/item:text-white text-sm">✓</span>
                        </div>
                        <p className="text-gray-700 text-base sm:text-lg">
