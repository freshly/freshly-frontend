...
const AboutPage = () => {
  return (
    <main className={`${inter.className} min-h-screen bg-white mt-16 sm:mt-20 md:mt-24`}>
      <div className="relative bg-grid-black">
        {/* Hero Section */}
        <section className="container mx-auto px-4 sm:px-6 py-12 sm:py-16 md:py-20 lg:py-24 relative">
          ...
          <div className="max-w-5xl mx-auto bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl overflow-hidden border border-gray-200 mb-6 sm:mb-8 md:mb-10">
            <div className="flex flex-col md:flex-row">
              <div className="w-full md:w-1/2 p-6 sm:p-8 order-2 md:order-1">
              ...
              <div className="w-full md:w-1/2 p-6 sm:p-8 order-1 md:order-2">
                <div className="relative h-64 sm:h-80 md:h-96 lg:h-[400px] w-full rounded-xl overflow-hidden">
                  <Image
                    src="/Aura .png"
          ...
          <div className="max-w-5xl mx-auto bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl overflow-hidden border border-gray-200">
            <div className="flex flex-col md:flex-row-reverse">
              ...
              <div className="w-full md:w-1/2 p-6 sm:p-8 order-1 md:order-2">
                <div className="relative h-64 sm:h-80 md:h-96 lg:h-[400px] w-full rounded-xl overflow-hidden bg-gray-100">
                  {/* Placeholder for George's image */}
                  <div className="flex items-center justify-center h-full">
                    <p className="text-gray-400 text-lg">Photo Coming Soon</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <section className="container mx-auto px-4 sm:px-6 py-12 sm:py-16 md:py-20 relative">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-light mb-6 sm:mb-8 text-center text-neutral-950">
              A Bit About Me
            </h2>
            <p className="text-sm sm:text-base md:text-lg text-neutral-600 leading-relaxed mb-8 px-4 sm:px-0">
